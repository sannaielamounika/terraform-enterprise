################################################################################
# FILE DEFINITION : iam.tf for EKS Module Creates IAM roles and permissions required by EKS and its components. It determines what AWS resources the cluster and nodes are allowed to access.
################################################################################
